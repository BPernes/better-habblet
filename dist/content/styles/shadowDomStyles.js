...
`,I=["cursor-pointer","navigation-item","icon"],b=["d-flex","overflow-hidden","position-relative","flex-column","card","handitem-menu"],c=["position-absolute","draggable-window"],Z="z-index: 401; top: calc(-170px + 38vh); left: 110px; transform: translate(393px, 130px); visibility: visible;",t=["d-flex","position-relative","flex-column","gap-2","align-items-center","justify-content-center","container-fluid","card-header"],N=["d-flex","w-100","align-items-center","justify-content-center"],G=["card-header-text"],m=["position-absolute","end-0","close-icon"],d=["grid-container"],l=["img-wrapper","d-flex","justify-content-center"],A=new CSSStyleSheet;A.replaceSync(i);var e=A;})();
