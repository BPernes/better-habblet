...
const GREY_ICONS = {
  path: {
    16: '../resources/images/icon-16-grey.png',
    32: '../resources/images/icon-32-grey.png',
    48: '../resources/images/icon-48-grey.png',
    128: '../resources/images/icon-128-grey.png',
  },
}
const DEFAULT_ICONS = {
  path: {
  ...
  if (details.reason === 'install') {
    try {
      await chrome.storage.sync.set({
        radioPlayerStatus: 'true',
        radioPanelStatus: 'true',
      })
    } catch (e) {
